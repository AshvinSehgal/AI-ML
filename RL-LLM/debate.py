...
# import transformers
# from transformers import AutoTokenizer, GenerationConfig, AutoModelForSequenceClassification, AutoModelForSeq2SeqLM, AutoModelForCausalLM
...
#         output = self.model.generate(tokens.input_ids, attention_mask=tokens.attention_mask)
